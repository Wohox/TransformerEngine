 ...
 *  \param[in]     stream                CUDA stream to wait on.
 */
void nvte_device_cutlass_grouped_gemm_mxfp8nvfp4(const void** A_and_SF_addrs, const NVTETensor* B, NVTETensor* D,
...
void nvte_device_cutlass_grouped_gemm_wgrad_mxfp8nvfp4(const NVTETensor* A, const NVTETensor* B, void** D,
...
void nvte_device_cutlass_grouped_gemm_fp16bf16(const void** A_addrs, const NVTETensor* B, NVTETensor* D,
                                      const int64_t* m_splits, const int gemm_m, const NVTETensor* bias,
                                      NVTETensor* pre_gelu_out, const int num_gemms, bool transa,
                                      bool transb, bool grad, NVTETensor* workspace, size_t workspaceSize,
                                      bool use_split_accumulator, int math_sm_count,
                                      cudaStream_t stream);

void nvte_device_cutlass_grouped_gemm_wgrad_fp16bf16(const NVTETensor* A, const NVTETensor* B, void** D,
                                        transformer_engine::DType D_type, const int64_t* m_splits, const NVTETensor* bias,
                                        NVTETensor* pre_gelu_out, const int num_gemms, bool transa,
                                        bool transb, NVTETensor* workspace, size_t workspaceSize,
                                        bool accumulate, bool* accumulate_mask, bool use_split_accumulator,
