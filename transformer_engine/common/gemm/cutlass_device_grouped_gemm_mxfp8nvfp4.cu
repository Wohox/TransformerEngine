 ...
 ************************************************************************/
 ...
 void nvte_device_cutlass_grouped_gemm_mxfp8nvfp4(const void **A_and_SF_addrs, const NVTETensor *B,
                                       ...
                                       cudaStream_t stream) {
   NVTE_API_CALL(nvte_device_cutlass_grouped_gemm_mxfp8nvfp4);
 ...
 void nvte_device_cutlass_grouped_gemm_wgrad_mxfp8nvfp4(
   ...
   NVTE_API_CALL(nvte_device_cutlass_grouped_gemm_wgrad_mxfp8nvfp4);
   using namespace transformer_engine;
